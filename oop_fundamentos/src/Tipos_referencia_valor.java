...
public class Tipos_referencia_valor {
	...
	public static void main(String[] args) {
		 ...
		 * - variáveis cujo tipo são classes não devem ser entendidas como caixas, mas
		 ...
		 * - o valor de uma variável do tipo primitivo é copiado para outra variável
		 * quando é atribuída;
		 * 
		 * Valores padrão
		 ...
		 * - Objetos precisam ser instanciados usando new, ou apontar para um objeto já
		 * existente;
		 * - Aceita valor null
		 * - Y = X; -> y passa a apontar para onde x aponta;
		 * - objetos instanciados no heap
		 * - objetos não utilizados são desalocados em um momento próximo pelo garbage
		 * colector;
		 * 
		 ...
		 * - "objetos" são desalocados imediatamente quando seu escopo de execução é
		 * finalizado;
		 *
		 */
