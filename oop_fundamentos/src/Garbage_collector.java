...
public class Garbage_collector {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Garbage collector:
		 * - processo que automatiza o gerenciamento de memória de um programa de
		 * execução -> automatiza o heap;
		 ...
		 * Variáveis locais são desalocadas imediatamente assim que seu escopo local sai
		 * de execução;
		 */
